...
const features = [
  {
    ...
    description: "Your assets are visible only to approved network members. Every listing stays within the vault — no public indexing, no unwanted exposure.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Verified Broker Network",
    description: "Every member is a real, active broker. No anonymous buyers, no time-wasters — just qualified professionals ready to deal.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Direct Broker Messaging",
    description: "Connect with interested brokers directly inside the platform. Every conversation is tied to a specific listing for complete clarity.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Owner-Controlled Access",
    description: "Platform owners control membership, listings moderation, and every setting. Your network, your rules. Invite only.",
    visual: "security",
  },
];
...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-16 py-10 lg:py-20 border-b border-foreground/10">
        {/* Number */}
        ...
        <div className="flex-1 grid lg:grid-cols-2 gap-8 items-center">
          <div>
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-display mb-4 group-hover:translate-x-2 transition-transform duration-500">
              {feature.title}
            </h3>
